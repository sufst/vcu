...
static const driver_profile_t motor_testing_profile = {DRIVER_PROFILE_MOTOR_TESTING, "Motor Testing", motor_testing_throttle_map};
...
/**
 * @brief 		Apply the torque map of the specified driver profile to the input
 * 		
