...
#define TRACEX_ENABLED_EVENTS                                                  \
    (TX_TRACE_BYTE_POOL_EVENTS | TX_TRACE_MUTEX_EVENTS | TX_TRACE_QUEUE_EVENTS \
     | TX_TRACE_SEMAPHORE_EVENTS | TX_TRACE_THREAD_EVENTS                      \
     | TX_TRACE_TIME_EVENTS | TX_TRACE_TIMER_EVENTS | TX_TRACE_USER_EVENTS)
...
#define TRACE_APPS_INPUT_EVENT      0x2002
