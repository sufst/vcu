 ...
 */
// static can_msg_t pm100_command_msg = {.tx_header = {PM100_CAN_ID_OFFSET +
// 0x020,
//                                                     FDCAN_STANDARD_ID,
//                                                     FDCAN_DATA_FRAME,
//                                                     FDCAN_DLC_BYTES_8,
...
pm100_status_t pm100_command_tx(pm100_command_t* command_data)
{
    ...
    // pm100_command_msg.data[1] = ((command_data->torque_command & 0xFF00) >>
    // 8); pm100_command_msg.data[2] = (command_data->speed_command & 0x00FF);
    // pm100_command_msg.data[3] = ((command_data->speed_command & 0xFF00) >>
    // 8); pm100_command_msg.data[4] = command_data->direction;
    ...
    // pm100_command_msg.data[6] = (command_data->commanded_torque_limit &
    // 0x00FF); pm100_command_msg.data[7]
